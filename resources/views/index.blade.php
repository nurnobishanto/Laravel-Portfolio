	...
	<div class="dizme_tm_all_wrap" data-magic-cursor="show">
			...
			<div class="dropdown">
				<div class="dropdown_inner">
					<ul class="anchor_nav">
						...
						<li class="download_cv"><a href="{{ asset('front') }}/img/cv/1.jpg" download><span>Download CV</span></a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="dizme_tm_hero">
				...
				<div class="container">
					<div class="content">
						...
						<div class="avatar">
							<div class="image">
								<img src="{{ asset('front') }}/img/slider/avatar.jpg" alt="" />
								<span class="skills illustrator anim_moveBottom"><img class="svg" src="{{ asset('front') }}/img/svg/skills/illustrator.svg" alt="" /></span>
								<span class="skills photoshop anim_moveBottom"><img class="svg" src="{{ asset('front') }}/img/svg/skills/photoshop.svg" alt="" /></span>
								<span class="skills figma anim_moveBottom"><img class="svg" src="{{ asset('front') }}/img/svg/skills/figma.svg" alt="" /></span>
							</div>
						</div>
					</div>
				</div>
						...
						<ul>
							<li class="wow fadeInUp" data-wow-duration="1s">
								<div class="list_inner">
									<div class="icon">
										<span>
											<img class="brush" src="{{ asset('front') }}/img/brushes/process/1.png" alt="" />
											<img class="svg" src="{{ asset('front') }}/img/svg/process/target.svg" alt="" />
										</span>
									</div>
									<div class="title">
										<h3>Pixel Perfect</h3>
							...
							<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
								<div class="list_inner">
									<div class="icon">
										<span>
											<img class="brush" src="{{ asset('front') }}/img/brushes/process/2.png" alt="" />
											<img class="svg" src="{{ asset('front') }}/img/svg/process/brush.svg" alt="" />
										</span>
									</div>
									<div class="title">
										<h3>High Quality</h3>
							...
							<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
								<div class="list_inner">
									<div class="icon">
										<span>
											<img class="brush" src="{{ asset('front') }}/img/brushes/process/3.png" alt="" />
											<img class="svg" src="{{ asset('front') }}/img/svg/process/energy.svg" alt="" />
										</span>
									</div>
									<div class="title">
										<h3>Awesome Idea</h3>
		...
		<div class="dizme_tm_section" id="about">
			<div class="dizme_tm_about">
				...
				<div class="brush_1 wow fadeInLeft" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/about/1.png" alt="" /></div>
				<div class="brush_2 wow fadeInRight" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/about/2.png" alt="" /></div>
			</div>
		</div>
		<!-- /ABOUT -->
		...
		<div class="dizme_tm_section" id="portfolio">
			<div class="dizme_tm_portfolio">
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Mockup Shape" data-category="Youtube">
										<a class="popup-youtube" href="https://www.youtube.com/watch?v=7e90gBu4pas">
											...
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/1.jpg"></div>
										</a>
									</div>
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Ave Bottle" data-category="Vimeo">
										<a class="popup-vimeo" href="https://vimeo.com/337293658">
											...
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/2.jpg"></div>
										</a>
									</div>
									<div class="mobile_title">
										<h3>Ave Bottle</h3>
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Magic Art" data-category="Soundcloud">
										<a class="soundcloude_link mfp-iframe audio" href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/471954807&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">
											<img src="{{ asset('front') }}/img/thumbs/42-56.jpg" alt="" />
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/3.jpg"></div>
										</a>
									</div>
									<div class="mobile_title">
										<h3>Magic Art</h3>
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Scott Felix" data-category="Popup">
										<a class="zoom" href="{{ asset('front') }}/img/portfolio/5.jpg">
											<img src="{{ asset('front') }}/img/thumbs/42-56.jpg" alt="" />
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/5.jpg"></div>
										</a>
									</div>
									<div class="mobile_title">
										<h3>Blue Lemon</h3>
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Art Stone" data-category="Popup">
										<a class="zoom" href="{{ asset('front') }}/img/portfolio/4.jpg">
											<img src="{{ asset('front') }}/img/thumbs/42-34.jpg" alt="" />
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/4.jpg"></div>
										</a>
									</div>
									<div class="mobile_title">
										<h3>Art Stone</h3>
								...
								<div class="inner">
									<div class="entry dizme_tm_portfolio_animation_wrap" data-title="Global Evolution" data-category="Detail">
										<a class="portfolio_popup" href="#">
											<img src="{{ asset('front') }}/img/thumbs/42-34.jpg" alt="" />
											<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/6.jpg"></div>
										</a>
									</div>
									<div class="mobile_title">
											...
											<div class="additional_images">
												<ul>
													<li>
														<div class="list_inner">
															<div class="my_image">
																<img src="{{ asset('front') }}/img/thumbs/4-2.jpg" alt="" />
																<div class="main" data-img-url="{{ asset('front') }}/img/portfolio/1.jpg"></div>
															</div>
														</div>
													</li>
				...
				<div class="brush_1 wow zoomIn" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/portfolio/1.png" alt="" /></div>
				<div class="brush_2 wow fadeInRight" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/portfolio/2.png" alt="" /></div>
			</div>
		</div>
		<!-- /PORTFOLIO -->
			...
			<div class="dizme_tm_skills">
				<div class="container">
					<div class="wrapper">
						...
						<div class="right">
							<img src="{{ asset('front') }}/img/skills/1.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="dizme_tm_section" id="service">
			<div class="dizme_tm_services">
						...
						<ul>
							<li class="wow fadeInLeft" data-wow-duration="1s">
								<div class="list_inner tilt-effect">
									<span class="icon">
										<img class="svg" src="{{ asset('front') }}/img/svg/service/anchor.svg" alt="" />
										<img class="back" src="{{ asset('front') }}/img/brushes/service/1.png" alt="" />
									</span>
									<div class="title">
									...
									<img class="popup_service_image" src="{{ asset('front') }}/img/service/1.jpg" alt="" />
							...
							<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
								<div class="list_inner tilt-effect">
									<span class="icon">
										<img class="svg" src="{{ asset('front') }}/img/svg/service/physics.svg" alt="" />
										<img class="back" src="{{ asset('front') }}/img/brushes/service/2.png" alt="" />
									</span>
									<div class="title">
									...
									<a class="dizme_tm_full_link" href="#"></a>
									<img class="popup_service_image" src="{{ asset('front') }}/img/service/2.jpg" alt="" />
									<div class="service_hidden_details">
										<div class="service_popup_informations">
											<div class="descriptions">
												<p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
							...
							<li class="wow fadeInLeft" data-wow-duration="1s">
								<div class="list_inner tilt-effect">
									<span class="icon">
										<img class="svg" src="{{ asset('front') }}/img/svg/service/contact.svg" alt="" />
										<img class="back" src="{{ asset('front') }}/img/brushes/service/3.png" alt="" />
									</span>
									<div class="title">
										<h3>UI/UX Design</h3>
									...
									<a class="dizme_tm_full_link" href="#"></a>
									<img class="popup_service_image" src="{{ asset('front') }}/img/service/3.jpg" alt="" />
									<div class="service_hidden_details">
										<div class="service_popup_informations">
											<div class="descriptions">
												<p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
							...
							<li class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
								<div class="list_inner tilt-effect">
									<span class="icon">
										<img class="svg" src="{{ asset('front') }}/img/svg/service/web.svg" alt="" />
										<img class="back" src="{{ asset('front') }}/img/brushes/service/4.png" alt="" />
									</span>
									<div class="title">
										<h3>Web Design</h3>
									...
									<a class="dizme_tm_full_link" href="#"></a>
									<img class="popup_service_image" src="{{ asset('front') }}/img/service/4.jpg" alt="" />
									<div class="service_hidden_details">
										<div class="service_popup_informations">
											<div class="descriptions">
												<p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
				...
				<div class="brush_1 wow fadeInLeft" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/service/5.png" alt="" /></div>
				<div class="brush_2 wow zoomIn" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/service/6.png" alt="" /></div>
			</div>
		</div>
		<!-- /SERVICES -->
		...
		<div class="dizme_tm_section">
			<div class="dizme_tm_testimonials">
					...
					<div class="total">
						<div class="in">
							<ul class="owl-carousel owl-theme">
								<li>
									<div class="icon">
										<img class="svg" src="{{ asset('front') }}/img/svg/testimonials/quote.svg" alt="" />
									</div>
									<div class="text">
									...
									<div class="short">
										<div class="image">
											<div class="main" data-img-url="{{ asset('front') }}/img/testimonials/4.jpg"></div>
										</div>
										<div class="detail">
											<h3>Mike Anderson</h3>
								...
								<li>
									...
									<div class="short">
										<div class="image">
											<div class="main" data-img-url="{{ asset('front') }}/img/testimonials/3.jpg"></div>
										</div>
										<div class="detail">
											<h3>Keita Smith</h3>
											<span>ABC Group</span>
								...
								<li>
									...
									<div class="short">
										<div class="image">
											<div class="main" data-img-url="{{ asset('front') }}/img/testimonials/6.jpg"></div>
										</div>
										<div class="detail">
											<h3>Alan Walker</h3>
						...
						<div class="left_details">
							<div class="det_image one wow fadeIn" data-wow-duration="1s" data-img-url="{{ asset('front') }}/img/testimonials/2.jpg"></div>
							<div class="det_image two wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" data-img-url="{{ asset('front') }}/img/testimonials/1.jpg"></div>
							<div class="det_image three wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" data-img-url="{{ asset('front') }}/img/testimonials/3.jpg"></div>
							<div class="det_image four wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s" data-img-url="{{ asset('front') }}/img/testimonials/4.jpg"></div>
							<span class="circle green animPulse"></span>
							<span class="circle yellow animPulse"></span>
							<span class="circle border animPulse"></span>
						</div>
						<div class="right_details">
							<div class="det_image one wow fadeIn" data-wow-duration="1s" data-img-url="{{ asset('front') }}/img/testimonials/5.jpg"></div>
							<div class="det_image two wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" data-img-url="{{ asset('front') }}/img/testimonials/6.jpg"></div>
							<div class="det_image three wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" data-img-url="{{ asset('front') }}/img/testimonials/7.jpg"></div>
							<span class="circle yellow animPulse"></span>
				...
				<div class="brush_1 wow fadeInRight" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/testimonials/1.png" alt="" /></div>
			</div>
		</div>
		<!-- /TESTIMONIALS -->
		...
		<div class="dizme_tm_section">
			<div class="dizme_tm_partners">
				...
				<div class="brush_1 wow fadeInLeft" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/partners/1.png" alt="" /></div>
			</div>
		</div>
		<!-- /PARTNERS -->
		...
		<div class="dizme_tm_section" id="blog">
			<div class="dizme_tm_news">
						...
						<ul>
							...
							<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
								<div class="list_inner">
									<div class="image">
										<img src="{{ asset('front') }}/img/thumbs/42-29.jpg" alt="" />
										<div class="main" data-img-url="{{ asset('front') }}/img/news/3.jpg"></div>
										<div class="date">
											<h3>23</h3>
											<span>Dec</span>
										</div>
				...
				<div class="brush_1 wow zoomIn" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/news/1.png" alt="" /></div>
				<div class="brush_2 wow zoomIn" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/news/2.png" alt="" /></div>
			</div>
		</div>
		<!-- /NEWS -->
			...
			<div class="dizme_tm_contact">
				<div class="container">
					...
					<div class="contact_inner">
						...
						<div class="brush_2 wow fadeInRight" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/contact/2.png" alt="" /></div>
					</div>
				...
				<div class="brush_1 wow fadeInLeft" data-wow-duration="1s"><img src="{{ asset('front') }}/img/brushes/contact/1.png" alt="" /></div>
			</div>
		</div>
		<!-- /CONTACT -->
